...
# 2.2: Machine Learning Classification of FLD 
...
### <u> 2.2.3.4. Feature Set Definition </u>
...
# stratified 5-fold cross-validation - using stratified instead of standard bc of class proportion consistency 
skf = StratifiedKFold(n_splits=5, shuffle=True, random_state=MY_RANDOM_STATE)
...
### <u> 2.2.5.5  Confusion Matrix Analysis </u>
...
### <u> 2.2.6  Model Comparison and Discussion </u>
