...
# stratified 5-fold cross-validation - using stratified instead of standard to maintain consistent class proportions 
...
for k in bio_k_values:
    ...
    #need to scale
    bio_scores = bio_cross_val_score(
        bio_knn_cv,
        X_bio_train_scaled,
        Y_bio_train,
        cv=skf,
...
best_k_core = bio_k_values[cv_scores.index(max(cv_scores))]

output=(
  f"Best biomarker K: {best_k_bio}\n" +
  f"Best biomarker CV accuracy: {best_k_bio}")
print(output)
```
#code block is a mess. It's 2:39 AM im going to bed
